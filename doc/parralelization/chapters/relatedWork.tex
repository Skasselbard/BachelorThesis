...
As a performant test system, a server (ebro) was used. Ebro has 4 AMD Opteron\texttrademark 6284 SE processors. Each with 16 cores and 2.7GHz base clock with a max boost of 3.4GHz\cite{AMDSpecs}. This sums up to 64 physical cpu cores (and threads) in total. As physical memory, 995.2 GHz are installed. The operating system is CentOS Linux 7 Core (collected with the hostnamectl command).
