\begin{tikzpicture}
    \begin{axis}[width=0.9\textwidth,height=0.9\textheight,
        ...
        \addplot table [ y=mara-atomics, col sep=comma,trim cells=true] {data/performanceMeasurements1000buckets.csv};
        \addplot table [y=mara-pthread, col sep=comma,trim cells=true] {data/performanceMeasurements1000buckets.csv};
