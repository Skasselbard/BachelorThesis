...
\begin{tikzpicture}
    ...
    \end{axis}
\end{tikzpicture}
\caption{Single thread comparison between all implementations\\ LoLA call: "lola --check=full --threads=1 ../tests/testfiles/phils1000.lola" }
\label{SingleThreadBenchmark}
\end{figure}