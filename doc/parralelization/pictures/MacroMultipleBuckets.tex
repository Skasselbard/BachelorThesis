...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot [green, fill=green!30] table [x=maraIntegration-t4-b1000, y expr=4, col sep=comma,trim cells=true] {data/allMacroData.csv};
    ...
    \end{axis}
\end{tikzpicture}
\caption{Mara comparison with 100 and 1000 buckets\\ LoLA call: "lola --check=full --threads=\{1,2,3,4,20,50\} --bucketing=\{100,1000\} ../tests/testfiles/phils1000.lola" }
\label{MaraBucketComparison}
\end{figure}