...
# SVN Revision-URL
m4_define([SVNURL],               [http://svn.gna.org/viewcvs/service-tech?rev=3021M&view=rev])

# directories
m4_define([TESTFILES],            [/home/tom/Development/lola-2.0/tests/testfiles])
m4_define([BENCHRESULTS],         [/home/tom/Development/lola-2.0/tests/benchmarks-results])
...
m4_define([LOLA],       [cover.sh /home/tom/Development/lola-2.0/src/lola --nolog])
m4_define([LISTENER],   [cover.sh /home/tom/Development/lola-2.0/utils/listener])
m4_define([KILLER],     [cover.sh /home/tom/Development/lola-2.0/utils/killer])

# the main executable, directly called to allow for analysis
m4_define([LOLA_RAW],  [/home/tom/Development/lola-2.0/src/lola --nolog])

# a LoLA call to check the logging functionality
m4_define([LOLA_LOG],  [cover.sh /home/tom/Development/lola-2.0/src/lola])
