...
\eject \pdfpagewidth=30cm \pdfpageheight=22cm


\tikzstyle{abstract}=[rectangle, draw=black, rounded corners, fill=blue!40, drop shadow,
text centered, anchor=north, text=white, text width=3cm]
\tikzstyle{comment}=[rectangle, draw=black, rounded corners, fill={rgb:red,10;green,1;yellow,10}, drop shadow,
text centered, anchor=north, text=white, text width=3cm]
\tikzstyle{myArrow}=[->, >=open triangle 90, thick]
\tikzstyle{line}=[-, thick]

\begin{tikzpicture}[node distance=2cm, align=center]
\node (Item) [abstract, rectangle split, rectangle split parts=2, fill=green!40]
{
    \textbf{ITEM}
    \nodepart{second}name
};
