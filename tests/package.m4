...
# SVN Revision-URL
m4_define([SVNURL],               [http://svn.gna.org/viewcvs/service-tech?rev=3017M&view=rev])

# directories
m4_define([TESTFILES],            [/Users/karsten/Documents/tpp/tools/lola2/tests/testfiles])
m4_define([BENCHRESULTS],         [/Users/karsten/Documents/tpp/tools/lola2/tests/benchmarks-results])

# standard UNIX helper tools
m4_define([GREP],                 [/usr/bin/grep])
m4_define([AWK],                  [awk])
m4_define([SED],                  [/usr/local/bin/gsed])
...
m4_define([LOLA],       [cover.sh /Users/karsten/Documents/tpp/tools/lola2/src/lola --nolog])
m4_define([LISTENER],   [cover.sh /Users/karsten/Documents/tpp/tools/lola2/utils/listener])
m4_define([KILLER],     [cover.sh /Users/karsten/Documents/tpp/tools/lola2/utils/killer])

# the main executable, directly called to allow for analysis
m4_define([LOLA_RAW],  [/Users/karsten/Documents/tpp/tools/lola2/src/lola --nolog])

# a LoLA call to check the logging functionality
m4_define([LOLA_LOG],  [cover.sh /Users/karsten/Documents/tpp/tools/lola2/src/lola])
...
m4_define([VALGRIND],             [wrap.sh /usr/local/bin/valgrind])
